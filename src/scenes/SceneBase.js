...
export class SceneBase {
    constructor(containerElement, options = {}) {
        ...
        this.isVisible = true;
        this.intersectionObserver = new IntersectionObserver(this.onVisibilityChange, { threshold: 0.0 });
    ...
    onTouchDownWrapper(e) {
        if (event.touches.length > 0 && this.onTouchDown) {
            ...
            const x = (this.touchDownX = e.touches[0].clientX / this.width - 0.5);
            const y = (this.touchDownY = e.touches[0].clientY / this.height - 0.5);
    ...
    onTouchMoveWrapper(e) {
        if (event.touches.length > 0) {
            const x = (this.touchMoveX = e.touches[0].clientX / this.width - 0.5);
            const y = (this.touchMoveY = e.touches[0].clientY / this.height - 0.5);
    ...
    onResizeWrapper() {
        ...
        if (renderer) {
            ...
            renderer.setPixelRatio((window.devicePixelRatio || 1.0) / this.scale);
        }
