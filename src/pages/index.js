            ...
            <Typography component="div" paragraph={true}>
                ...
                <Typography component={'div'} paragraph={true}>
                    ...
                    <Typography component={'div'} variant="body1" paragraph={true}>
                        ...
                        {`In the past, most students have found it is possible to pass
                            the course without opening the textbook once, as almost all
                            graded material is provided through lecture and precepts;
                            nevertheless, this textbook will prove extremely useful for
                            especially eager and motivated students who wish to pursue
                            further studies in computer graphics. In addition to covering
                            graphics concepts that could not otherwise squeeze into this course,
                            the textbook contains wonderful C++ and OpenGL implementations
                            that all graphics programmers would be well-suited to know.`}
                    </Typography>
                </Typography>
            </Typography>
            <Typography component={'div'} paragraph={true}>
