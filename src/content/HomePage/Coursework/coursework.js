const coursework = {
    ...
    exam: [
        ...
        on the Thursday of midterms week. The exam
        ...
        be posted; however, note that past exams may
        have covered different material. Students may also find
        the qualitative exercises avaliable on the course website helpful when
        preparing for the exam, but they should expect more quantative questions
        on the exam itself.`,
        ...
        following Spring Recess. Effectively, these questions
    ...
    assignments: [
        ...
        Dropbox, also known as  TigerFile. Students should
        look for the submission link in the description of each
        assignment, login with their Princeton netID, and then submit
        all applicable files by the posted deadline. Students may resubmit
